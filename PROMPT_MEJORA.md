...
import { DecisionService } from './application/services/decisionService';
...
@Module({
  imports: [TypeOrmModule.forFeature([Action, Decision])],
  providers: [ActionService, DecisionService, ActionRepository, DecisionRepository],
})
export class TeamPPModule {}

// === ARCHIVO: src/domain/entities/action.ts ===
...
// === ARCHIVO: src/domain/entities/decision.ts ===
import { Entity, Column, PrimaryGeneratedColumn } from 'typeorm';
...
// === ARCHIVO: src/application/services/actionService.ts ===
...
// === ARCHIVO: src/application/services/decisionService.ts ===
import { Injectable } from '@nestjs/common';
import { InjectRepository } from '@nestjs/typeorm';
import { Repository } from 'typeorm';
import { Decision } from '../domain/entities/decision';
...
// === ARCHIVO: src/infrastructure/repositories/actionRepository.ts ===
...
// === ARCHIVO: src/infrastructure/repositories/decisionRepository.ts ===
import { EntityRepository, Repository } from 'typeorm';
import { Decision } from '../domain/entities/decision';
...
// === ARCHIVO: src/main/config/database.ts ===
...
// === ARCHIVO: tests/actionService.spec.ts ===
...
// === ARCHIVO: tests/decisionService.spec.ts ===
import { Test, TestingModule } from '@nestjs/testing';
